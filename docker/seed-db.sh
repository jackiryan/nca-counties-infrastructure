...
/usr/local/bin/seed_nca_atlas.py --files \
    /data/sources/NCA_Atlas_Figures_Beta_Counties_view_-3211749018570635702.geojson 1.5 \
    ...
    --dbname ar_climate_data --host localhost --user postgres --password postgres